...
// Define the document interface to match the backend response
...
export const fetchDocuments = async (): Promise<Document[]> => {
  try {
    ...
    const response =
      await apiClient.get<DocumentListResponse>("/documents/list");
    console.log("Documents response from backend:", response.data);
