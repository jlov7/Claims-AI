      ...
      <ModalContent maxW="900px">
        ...
        <ModalBody>
          <VStack align="stretch" spacing={4}>
            <Text>
              Red Team evaluation tests the AI's robustness against various
              adversarial prompts, including attempts to override instructions,
              extract sensitive information, or provide harmful content.
            </Text>
                      ...
                      <h2>
                        <AccordionButton>
                          <Box flex="1" textAlign="left">
                            <Text fontWeight="bold">{attempt.prompt_id}</Text>
                          </Box>
                          <AccordionIcon />
                        </AccordionButton>
                      </h2>
            ...
            {loading && (
              <Box textAlign="center" py={10}>
                <Spinner size="xl" />
                <Text mt={4}>
                  Running Red Team evaluation against the AI system...
                </Text>
              </Box>
            )}
          </VStack>
