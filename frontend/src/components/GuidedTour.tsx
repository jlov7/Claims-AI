...
const GuidedTour: React.FC<GuidedTourProps> = ({ runTour, setRunTour }) => {
  ...
  const steps: Step[] = [
    {
      ...
      content:
        "Let's start by checking the lights at the top! Green means everything is ready and you can use Claims-AI with confidence.",
      placement: "bottom",
    ...
    },
    {
      ...
      content:
        "Simply drag and drop your claim files here, or click to browse. This is how you give the AI the information it needs to help you.",
      placement: "right",
    ...
    },
    {
      ...
      content:
        "Want a quick summary? Enter a document ID or paste some text here, and the AI will give you a clear, simple summary in seconds.",
      placement: "left",
    ...
    },
    {
      ...
      content:
        'This is your chat area. Ask any question about your documents—like "What\'s the claim amount?"—and the AI will find the answer for you.',
      placement: "top",
    ...
    },
    {
      ...
      content:
        "Type your question here and press Send. The AI will search your documents and reply right away.",
      placement: "top",
    ...
    },
    {
      ...
      content:
        "Here's where the AI's answers appear! Look for the confidence color (green is best) and click the play button to hear the answer out loud.",
      placement: "bottom",
    ...
    },
    {
      target: "#tour-chat-panel .ai-message:last-of-type",
      content:
        "Notice the colored border around AI answers? That's the confidence meter! Green means high confidence (4-5), yellow is medium (3), and red indicates low confidence (1-2). When confidence is low, the system automatically tries to improve its answer.",
      placement: "bottom",
    ...
    },
    {
      ...
      content:
        "This panel shows similar past cases, so you can see what happened before in situations like yours.",
      placement: "left",
    ...
    },
    {
      ...
      content:
        "Ready to write up your findings? Click here to instantly create a professional Word document with your strategy notes.",
      placement: "top",
    ...
    },
    {
      ...
      content:
        'Want to see how robust the AI is? Click here to run some "stress tests" and see how it handles tricky questions.',
      placement: "top",
    ...
    },
    {
      ...
      content:
        "Need more info? Click here anytime to see how Claims-AI works behind the scenes.",
      placement: "bottom",
    ...
    },
    {
      ...
      content:
        "You can restart this tour anytime by clicking here. Enjoy exploring Claims-AI!",
      placement: "bottom",
  ...
  const handleJoyrideCallback = useCallback(
    (data: CallBackProps) => {
      ...
      console.log("[GuidedTour] Joyride callback:", {
        action,
        index,
        status,
        type,
