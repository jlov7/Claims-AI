...
const StrategyNoteGenerator: React.FC<StrategyNoteGeneratorProps> = ({
  documentIds,
  chatHistory,
  claimSummary,
}) => {
  ...
  const handleGenerateAndDownload = async () => {
    ...
    try {
      ...
      toast({
        ...
        description:
          error.message || "Could not generate or download the strategy note.",
        status: "error",
        duration: 5000,
        isClosable: true,
      });
  ...
  return (
    ...
    >
      ...
      <CardBody p={6}>
        ...
        <FormControl>
          <FormLabel htmlFor="strategy-criteria" fontSize="sm">
            Optional Criteria:
          </FormLabel>
          <Textarea
