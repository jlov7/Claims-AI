...
# Configuration for OpenAI API (compatible with LM Studio)
# Using OLLAMA_API_BASE as the primary, falling back to a default if not set.
# This makes it consistent with the rest of the backend which uses OLLAMA_API_BASE.
OLLAMA_API_BASE = os.getenv("OLLAMA_API_BASE", "http://localhost:11434/v1")
OPENAI_API_KEY = os.getenv(
    "OPENAI_API_KEY", "ollama"
)  # Default key for Ollama, actual key for OpenAI
...
def get_embedding_function():
    ...
    try:
        ...
        print(f"Model='{EMBEDDING_MODEL_NAME}', API_Base='{OLLAMA_API_BASE}'")
        print(
